...
set LIST='COMBINE CONVOLVE COUNT DIFFSTAT ENSEMBLE HART HELICITY IBT-REF LANDFALL LIFECYCLE LOCATION MISC MULTI-IDENT RSHEAR SAMPLE SPLIT TELE_WEIGHTS TC TILT TRANSADD TRTRANS TR2KML TR2NC TR2PGSL SIEGEL TRACKADD'
...
ln -s ../COMMON/read_tracks.c HELICITY/read_tracks.c
ln -s ../COMMON/convert_track.c HELICITY/convert_track.c

# RSHEAR

ln -s ../COMMON/read_tracks.c RSHEAR/read_tracks.c
ln -s ../COMMON/realloc_n.c RSHEAR/realloc_n.c
ln -s ../COMMON/meantrd.c RSHEAR/meantrd.c
...
ln -s ../COMMON/read_tracks.c TRACKADD/read_tracks.c
ln -s ../COMMON/meantrd.c TRACKADD/meantrd.c
ln -s ../COMMON/realloc_n.c TRACKADD/realloc_n.c
